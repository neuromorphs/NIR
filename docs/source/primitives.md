...
| **Current-based leaky Integrator** | $\tau_\text{syn}$ [s], $\tau_\text{mem}$ [s], $R$ [Ω], $v_\text{leak}$ [V], $w_\text{in}$ | **LI**; **Linear**; **LI**                                       | -                                                                                      |
| **Current-based leaky integrate-and-fire** | $\tau_\text{syn}$ [s], $\tau_\text{mem}$ [s], $R$ [Ω], $v_\text{leak}$ [V], $v_\text{reset}$ [V], $v_\text{threshold}$ [V], $w_\text{in}$ | **LI**; **Linear**; **LIF**                              | $\begin{cases} v_\text{reset} & \text{Spike} \\ v_\text{LIF} & \text{else} \end{cases}$ |
| **Delay**                          | $\tau$ [s]                                                                | $I(t - \tau)$                                            | -                                                                                      |
| **Flatten**                        | Input shape, Start dim., End dim.                                         | -                                                        | -                                                                                      |
| **Integrator**                     | $R$ [Ω]                                                                   | $\dot{v} = R I$                                          | -                                                                                      |
| **Integrate-and-fire**             | $R$ [Ω], $v_\text{reset}$ [V], $v_\text{threshold}$ [V]                        | **Integrator**; **Threshold**                            | $\begin{cases} v_\text{reset} & \text{Spike} \\ v & \text{else} \end{cases}$         |
| **Leaky integrator (LI)**          | $\tau$ [s], $R$ [Ω], $v_\text{leak}$ [V]                                  | $\tau \dot{v} = (v_\text{leak} - v) + R I$               | -                                                                                      |
| **Linear**                         | $W$                                                      | $W I$                                                    | -                                                                                      |
| **Leaky integrate-fire (LIF)**     | $\tau$ [s], $R$ [Ω], $v_\text{leak}$ [V], $v_\text{reset}$ [V], $v_\text{threshold}$ [V] | **LI**; **Threshold**                                    | $\begin{cases} v_\text{reset} & \text{Spike} \\ v & \text{else} \end{cases}$         |
| **Scale**                          | $s$                                                                       | $s I$                                                    | -                                                                                      |
| **SumPooling**                     | $p$                                                                       | $\sum_{j} x_j$                                           | -                                                                                      |
| **AvgPooling**                     | $p$                                                                       | **SumPooling**; **Scale**                                | -                                                                                      |
| **Threshold**                          | $\theta_\text{threshold}$ [V]                                                   | $\delta(I - \theta_\text{threshold})$                               | -                                                                                      |
